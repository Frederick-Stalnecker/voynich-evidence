...
repository. The entries below are the twenty-five most consequential predictions, drawn from that
record.
...
> corresponding test was run. Of the twenty-five entries: seventeen carry explicit pre-registration
