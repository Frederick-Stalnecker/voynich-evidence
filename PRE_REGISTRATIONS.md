...
repository. The entries below are the twenty-one most consequential predictions, drawn from that
record.
...
> corresponding test was run. Of the twenty-one entries: thirteen carry explicit pre-registration
