...
repository. The entries below are the twenty-three most consequential predictions, drawn from that
record.
...
> corresponding test was run. Of the twenty-three entries: fifteen carry explicit pre-registration
