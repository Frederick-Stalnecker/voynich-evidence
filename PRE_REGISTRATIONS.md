...
repository. The entries below are the twenty-two most consequential predictions, drawn from that
record.
...
> corresponding test was run. Of the twenty-two entries: fourteen carry explicit pre-registration
