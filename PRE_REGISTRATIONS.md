...
repository. The entries below are the twenty most consequential predictions, drawn from that
record.
...
> corresponding test was run. Of the twenty entries: twelve carry explicit pre-registration
