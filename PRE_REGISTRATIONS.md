...
repository. The entries below are the twenty-four most consequential predictions, drawn from that
record.
...
> corresponding test was run. Of the twenty-four entries: sixteen carry explicit pre-registration
