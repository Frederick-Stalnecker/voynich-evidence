...
repository. The entries below are the nineteen most consequential predictions, drawn from that
record.
...
> corresponding test was run. Of the nineteen entries: ten carry explicit pre-registration
